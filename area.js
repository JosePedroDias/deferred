...
function render() {
	...
	areaLight1.position.x = Math.sin(time * 0.001  ) *  9;
	areaLight1.position.y = Math.sin(time * 0.0013 ) *  5 + 5;

	areaLight2.position.y = Math.sin(time * 0.0011 ) *  3 + 5;
	areaLight2.position.z = Math.sin(time * 0.00113) * 10;

	areaLight3.position.y = Math.sin(time * 0.00111) *  3 + 5;
	areaLight3.position.z = Math.sin(time * 0.001113) * 10;
